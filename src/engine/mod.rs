...
pub struct VpnEngine {
    ...
    pub current_up: u64,
    pub session_total_down: u64,
    pub session_total_up: u64,
    pub session_peak_down: u64,
    pub session_peak_up: u64,
    pub latency_ms: u64,
    pub packet_loss: f32,
    pub jitter_ms: u64,
    pub location: String,
...
impl VpnEngine {
    ...
    pub fn new(config: AppConfig, config_dir: PathBuf) -> Self {
        ...
        let mut engine = Self {
            ...
            latency_history: VecDeque::from(vec![0; history_size]),
            current_down: 0,
            current_up: 0,
            session_total_down: 0,
            session_total_up: 0,
            session_peak_down: 0,
            session_peak_up: 0,
            latency_ms: 0,
